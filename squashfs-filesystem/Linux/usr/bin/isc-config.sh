...
if test x"$echo_libs" = x"true"; then
	...
	if test x"$libdns" = x"true" ; then
		libs="$libs -ldns  -L/home/jenkins/jenkins_slave_builds_prod/workspace/idrac-13g-ducati1.7-master-release-A-Rev/build-yocto-sh4/tmp/sysroots/idrac8/usr/lib/../lib -lcrypto"
	fi
